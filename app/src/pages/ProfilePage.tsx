    ...
    <div className="min-h-dvh bg-ink-50 pb-16">
      ...
      <main className="max-w-md md:max-w-3xl mx-auto px-4 pt-5 space-y-4">
        ...
        <section className="bg-white rounded-2xl border border-ink-100 p-5 shadow-sm anim-fade-up">
          ...
          <div className="mt-5 rounded-2xl border border-gold-200 bg-gold-100 p-4 flex items-center justify-between">
            <div>
            ...
            <a href="#/me/follows" className="h-9 px-4 rounded-full bg-accent-500 text-white text-sm font-bold grid place-items-center shrink-0">去設定</a>
          </div>
