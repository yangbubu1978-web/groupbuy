  ...
  return (
    <div className="min-h-dvh bg-ink-50">
      ...
      <div className="max-w-md md:max-w-3xl mx-auto px-4 pt-3">
        <div className="rounded-2xl border border-gold-200 bg-gold-100 p-4 space-y-3">
          ...
          <div className="flex gap-2">
            ...
            <button onClick={saveEmail} disabled={emailBusy || !/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(emailInput.trim())} className="h-10 px-5 rounded-full bg-accent-500 text-white text-sm font-bold disabled:opacity-40 shrink-0">儲存</button>
          </div>
